...
Domain repositories provide modules. A module can be loaded from a local folder, a remote `module.json` URL, or a GitHub repository URL that exposes a module manifest.
