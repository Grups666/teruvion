...
const testFiles = [
  ...
  'core/map-expression-planner.test.js',
  'core/agent-runtime.test.js',
  'core/geojson-connector.test.js',
  'core/named-location-resolver.test.js',
  'core/spatial-resource-sampler.test.js',
  'core/spatial-repository-discovery.test.js',
  'core/url-connector.test.js',
  ...
  'core/digital-earth-decomposer-event-location.test.js',
